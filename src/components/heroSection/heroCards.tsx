...
const HeroCards = ({isVisible} : {isVisible : boolean}) => {
    ...
    return (
        <div className=" hidden md:flex w-full lg:w-1/3 xl:w-1/2 relative h-full" >
            {/* bg strips */}
            ...
            {/* white card */}
            <div className={`${isVisible ? " opacity-100 translate-y-0" : "opacity-0 translate-y-36"} duration-1500 ease-out delay-900 transition-all 
                flex flex-col gap-4 shadow-lg rounded-3xl p-6 min-h-[300px] md:w-72 lg:w-80 bg-white absolute lg:right-20  xl:right-46 md:top-10 lg:top-14 top-18 z-20`} >
            ...
            {/* little card */}
            <div className={`${isVisible ? " opacity-100 translate-y-0 " : "opacity-0 translate-y-40"} duration-1500 ease-out delay-1200 transition-all 
                flex flex-col  bg-primary text-white border-white shadow-xl rounded-3xl md:w-42 lg:w-48 min-h-[250px] md:right-2 lg:right-4 xl:right-26 md:top-4 lg:top-6 xl:top-10 z-30 absolute `} >
