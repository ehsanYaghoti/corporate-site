    ...
    return (
        <div ref={ref} className="w-full overflow-hidden flex items-start p-10 px-16 text-textColor justify-center min-h-screen h-[1000px] bg-netural " >
            <div className="flex flex-col items-start justify-start gap-6 w-1/2 p-8 " >
                ...
                <label className={`${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20 "} duration-1000 ease-out delay-200 transition-all flex gap-2 h-14 border border-black/20 min-w-[400px] p-px bg-white rounded-xl`}>
                ...
                <div className={`${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20 "} duration-1000 ease-out delay-300 transition-all flex items-center justify-between text-2xl font-semibold w-full mt-6 `} >
                    <span>Klarna</span>
                    <span>coinbase</span>
                    <span>instacart</span>
                </div>
